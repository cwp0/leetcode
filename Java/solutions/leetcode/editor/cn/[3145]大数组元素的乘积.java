// 
// @Question: [3145]大数组元素的乘积 
// @Author: cwp0
// @CreatedTime: 2024-08-23 12:19:43
// @Description: 
//一个非负整数 x 的 强数组 指的是满足元素为 2 的幂且元素总和为 x 的最短有序数组。下表说明了如何确定 强数组 的示例。可以证明，x 对应的强数组是独
//一无二的。 
//
// 
// 
...
//, 1, 4, 2, 4, 1, 2, 4, 8, ...] 。 
//
// 给你一个二维整数数组 queries ，其中 queries[i] = [fromi, toi, modi] ，你需要计算 (big_nums[
//fromi] * big_nums[fromi + 1] * ... * big_nums[toi]) % modi 。 
//
...
// 
//
// Related Topics 位运算 数组 二分查找 👍 22 👎 0
