// 
// @Question: [1600]王位继承顺序 
// @Author: cwp0
// @CreatedTime: 2024-04-07 12:56:04
// @Description: 
...
// 
//
// Related Topics 树 深度优先搜索 设计 哈希表 👍 90 👎 0
...
class ThroneInheritance {
    ...
    // n 叉树的前序遍历
    private void preorder(List<String> ans, String king) {
        if (! dead.contains(king)) {
            ans.add(king);
        }
        // getOrDefault获取指定键对应的值，如果该键不存在，则返回一个默认值new ArrayList<String>()
        List<String> children = edges.getOrDefault(king, new ArrayList<String>());
