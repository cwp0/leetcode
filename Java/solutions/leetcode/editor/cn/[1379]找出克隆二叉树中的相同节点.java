// 
// @Question: [1379]找出克隆二叉树中的相同节点 
// @Author: cwp0
// @CreatedTime: 2024-04-03 13:15:54
// @Description: 
...
class Solution {
    ...
    private TreeNode traverse(TreeNode root, TreeNode target) {
        if (root == null) {
            return null;
        }
        ...
        TreeNode res = traverse(root.left, target);
        if (res != null) {
            return res;
        }
